...
// var AJAX_loading_error_code = str.replace('{loader}', AAPLloadingIMG.attr('src'));
// /* funzione principale ajax reload */
//
...
//
//         jQuery('#' + AJAX_content).css("height", contentHeight + "px");
//         //applica manualmente l'altezza del contenuto
//
...
//
//                         jQuery('#' + AJAX_content).css("height", 'auto');
//                         //reimposta height automatica
//
...
// init Isotope
var $skill_grid = $('.grid.row.skill-grid').isotope({
    itemSelector: '.skill-item',
    layoutMode: 'fitRows'
});

// init Isotope
var $project_grid = $('.grid.project-grid').isotope({
...
$('#skill_filters').on( 'click', 'button', function() {
    var filterValue = $( this ).attr('data-filter');
    // use filterFn if matches value
    filterValue = filterFns[ filterValue ] || filterValue;
    $skill_grid.isotope({ filter: filterValue });
});

// bind filter button click
$('#project_filters').on( 'click', 'button', function() {
    var filterValue = $( this ).attr('data-filter');
    // use filterFn if matches value
    filterValue = filterFns[ filterValue ] || filterValue;
